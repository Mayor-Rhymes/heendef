...
$id = intval($_GET['id']);
$post=mysqli_query($conn,"SELECT * FROM blog WHERE id = '$id'");
...
<head>
  ...
  <title>Edit Post | Heendef Admin Dashboard</title>
            ...
            <form class="card-body" method="POST" enctype="multipart/form-data">
             <wbr>
                  ...
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingName" value="<?php echo htmlentities($pst['title']); ?>" name="title" >
                ...
                <br>
                    <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" class="form-control" id="floatingName" value="<?php echo htmlentities($pst['subject']); ?>" name="subject" maxlength="250" >
        ...
        quill.on('text-change', function() {
            ...
            document.getElementById('hidden-field').value = editorContent;
              ...
              <br>
                    ...
                    <div class="col-md-6">
                  <div class="form-floating">
                    <img  src="<?php echo htmlentities($pst['image_path']); ?>"  alt="Preview" style="max-width: 400px; max-height: 300px;" />
                    <hr>
              
                       <label for="floatingTextarea">Image</label>
                
        <br />
           <a href="img_post?id=<?php echo $pst['id']; ?>'"><button type="button" class="btn btn-primary btn-sm">Change Image <i class="bi bi-image"></i></button></a>
                  </div>
