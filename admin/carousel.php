...
<head>
  ...
  <title>Carousel Slide | Heendef Admin</title>
      ...
      <div class="row">
        ...
        function previewImage() {
            ...
            imagePreview.src = URL.createObjectURL(fileInput.files[0]);
                ...
                <div class="col-12">
                  <div class="form-floating">
                    <textarea class="form-control" name="subtitle" placeholder="Description" id="floatingTextarea" style="height: 100px;"></textarea>
