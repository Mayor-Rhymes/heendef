...
<head>
  ...
  <title>Volunteers | Heendef Admin</title>
          ...
          <div class="card">
            ...
            <?php } ?>
              ...
              <table class="table datatable">
                ...
                <tbody>
                  <?php $cnt=1; $qls = mysqli_query($conn,"SELECT * FROM volunteers ORDER BY id DESC");
                  ...
                  <tr>
                   ...
                   <td><?php echo htmlentities($row['email']); ?></td>
                    ...
                    <td>
                      <button onclick="window.location.href='view-vol?vid=<?php echo htmlentities($row['id']); ?>'" class="btn btn-success btn-sm"><i class="bi bi-eye"></i></button>
                      <button onclick="window.location.href='del-vol?vid=<?php echo htmlentities($row['id']); ?>';" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i></button>
                    </td>
                  </tr>
                <?php $cnt=$cnt+1;} ?>
                </tbody>
