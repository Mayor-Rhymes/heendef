...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_FILES["image"])) {
  ...
  $active = 0;
    ...
    $targetDirectory = "uploads/events/"; // Change this to the directory where you want to store the images
    ...
    $sql = "INSERT INTO events (title,body,evtDate,start,stop,location,code,image_name,image_path,completed) VALUES('$title','$body','$date','$start','$stop','$location','$code','$image_name','$image_path','$active')";
