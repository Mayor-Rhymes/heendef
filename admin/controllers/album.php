<?php
error_reporting(0);
if ($_SERVER["REQUEST_METHOD"] === "POST" && (strlen($_POST["title"]) > 3) && (strlen($_POST["subtitle"]) > 3)) {
    ...
    // $targetDirectory = "uploads/carousel/"; 
    ...
    // $active = 1;
    $sql = "INSERT INTO album (title, description ) VALUES ('$title','$subtitle')";
