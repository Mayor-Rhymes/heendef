...
<body>
    ...
    <div>
        ...
        <form style="width: 75%; margin-inline: auto; margin-bottom: 100px;">
            ...
            <div class="row">
                ...
                <div class="col-lg-12" style="margin-bottom: 10px">
                    ...
                    <textarea class="form-control" rows="7" placeholder="Please enter message" style="resize:none"></textarea>
